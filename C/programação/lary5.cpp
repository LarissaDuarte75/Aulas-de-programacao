...
int COD[100], QTDATUAL[100], PTCRITICO[100], I, L, 
int OPCOES,BUSCAR, NOVOCOD, NOVAQTDATUAL,NOVOPTCRITICO, VEND, MENOS;
...
scanf("%d", &VEND);
VALVEND = VEND * VALUNIT[L];
DEFA[L] = QTDATUAL[L] - PTCRITICO[L];
