...
main () {
	  ...
	  do{
		  ...
		  if("resposta == 2"){
	  	  ...
	  	  else{printf("(1),(3),(4), respostas incorretas");
		  ...
		  if("resposta == 3"){
	  		...
	  		printf("\n 3 e a resposta correta, E o ponto mais alto contando com 2995 metros de altura e fica no Amazonas \n\n");
		  }
	  	  else{
	  		printf("(1),(2),(4), respostas incorretas");
		  }
	  	...
	  	scanf("%d, &R4");
		   ...
		   if("resposta == 4"){
	  		...
	  		printf("\n 4 e a resposta correta, E transcontinental pois pertence a mais de um continente, Europa e Asia \n\n");
		  }
	  	  else{
	  		printf("(1),(2),(3), respostas incorretas");
		  }
